...
public:
	...
	bool CreateRenderTarget(VkFormat p_format, uint32_t p_width, uint32_t p_height, uint32_t p_mipLevel, VkImageLayout p_Layout, VkImageUsageFlags p_usage, Image& p_renderTarget, std::string p_DebugName);
