...
#define SAMPLE_RT_SHADOW_TEMPORAL_ACC			12
#define SAMPLE_RT_SHADOW_DENOISE				13
#define SAMPLE_MAX_RENDER_TARGETS			    14
...
#define STORE_RT_SHADOW_DENOISE					11
#define STORE_MAX_RENDER_TARGETS			    12
